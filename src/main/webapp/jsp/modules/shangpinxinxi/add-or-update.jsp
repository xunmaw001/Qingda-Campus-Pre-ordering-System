                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label>商品编号</label>
                                    <input id="shangpinbianhao" name="shangpinbianhao" class="form-control" value=""
                                           readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>商品名称</label>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="file" type="file" id="fengmianupload" class="form-control-file">
                                ...
                                <div class="form-group col-md-6">
                                    <label>折后价</label>
                                    <input id="discountprice" type="number" name="discountprice" class="form-control" placeholder="折后价">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>可得积分</label>
                                    <input id="jifen" type="number" name="jifen" class="form-control" placeholder="可得积分">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>上下架</label>
                                    <select id="flagSelect" name="flag" class="form-control">
